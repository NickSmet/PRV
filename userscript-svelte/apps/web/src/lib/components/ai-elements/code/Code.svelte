...
<div {...rest} bind:this={ref} class={cn(codeVariants({ variant }), className)}>
	<div class={cn("ai-code-wrapper", codeState.wrap && "ai-code-wrapper--wrap")}>
	...
	.ai-code-wrapper--wrap :global(pre.shiki) {
	...
	.ai-code-wrapper--wrap :global(pre.shiki code) {
		display: block;
		min-width: 0;
		white-space: pre-wrap;
	...
	.ai-code-wrapper--wrap :global(pre .line) {
		display: block;
		white-space: pre-wrap;
		word-break: break-word;
		overflow-wrap: anywhere;
