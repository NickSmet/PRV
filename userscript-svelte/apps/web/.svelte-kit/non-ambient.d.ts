...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/" | "/api" | "/api/chat" | "/api/chat/activity" | "/api/chat/chat" | "/api/chat/conversations" | "/api/reports" | "/api/reports/[id]" | "/api/reports/[id]/files-raw" | "/api/reports/[id]/files-raw/[...filePath]" | "/api/reports/[id]/files" | "/api/reports/[id]/files/[...filePath]" | "/api/reports/[id]/mental-model" | "/api/reports/[id]/model" | "/api/reports/[id]/nodes" | "/api/reports/[id]/nodes/[nodeKey]" | "/api/reports/[id]/raw" | "/api/reports/[id]/raw/node" | "/api/reports/[id]/raw/node/[nodeKey]" | "/lab" | "/lab/icons" | "/lab/[reportId=reportId]" | "/mcp" | "/nodes" | "/nodes/[reportId=reportId]" | "/[reportId=reportId]";
		RouteParams(): {
		...
		LayoutParams(): {
			...
			"/api/chat/activity": Record<string, never>;
			"/api/chat/chat": Record<string, never>;
			"/api/chat/conversations": Record<string, never>;
		...
		Pathname(): "/" | "/api/chat/activity" | "/api/chat/chat" | "/api/chat/conversations" | `/api/reports/${string}` & {} | `/api/reports/${string}/files-raw/${string}` & {} | `/api/reports/${string}/files/${string}` & {} | `/api/reports/${string}/mental-model` & {} | `/api/reports/${string}/model` & {} | `/api/reports/${string}/nodes/${string}` & {} | `/api/reports/${string}/raw/node/${string}` & {} | "/lab/icons" | `/lab/${string}` & {} | "/mcp" | `/nodes/${string}` & {} | `/${string}` & {};
