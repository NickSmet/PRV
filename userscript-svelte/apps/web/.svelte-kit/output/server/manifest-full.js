	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/chat/activity/_server.ts.js'))
			},
			{
				id: "/api/chat/chat",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/chat/chat/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/chat/conversations/_server.ts.js'))
			},
			{
				id: "/api/reports/[id]",
				pattern: /^\/api\/reports\/([^/]+?)\/?$/,
