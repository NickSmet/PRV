...
return {
	...
	_: {
		client: {start:"_app/immutable/entry/start.x96iPocw.js",app:"_app/immutable/entry/app.BJe9YK_t.js",imports:["_app/immutable/entry/start.x96iPocw.js","_app/immutable/chunks/t0kWq-PI.js","_app/immutable/chunks/C4VK0hGy.js","_app/immutable/chunks/BUApaBEI.js","_app/immutable/chunks/CBxfP6Il.js","_app/immutable/entry/app.BJe9YK_t.js","_app/immutable/chunks/C4VK0hGy.js","_app/immutable/chunks/U5Xtynwb.js","_app/immutable/chunks/C2nA3h8A.js","_app/immutable/chunks/0tib0vb6.js","_app/immutable/chunks/CBxfP6Il.js","_app/immutable/chunks/DBeFtvaN.js"],stylesheets:[],fonts:[],uses_env_dynamic_public:false},
		nodes: [
			__memo(() => import('./chunks/0-DjvCOPSy.js')),
			__memo(() => import('./chunks/1-DdAYx2SG.js')),
			__memo(() => import('./chunks/2-EMXFDZ_D.js')),
			__memo(() => import('./chunks/3-B8qvOmMq.js')),
			__memo(() => import('./chunks/4-Dp9GGujP.js')),
			__memo(() => import('./chunks/5-uqUIrw_6.js')),
			__memo(() => import('./chunks/6-DmzaorxZ.js'))
		],
		remotes: {
		...
		routes: [
			...
			},
			{
				...
				pattern: /^\/api\/chat\/activity\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-CqJlNWGR.js'))
			},
			{
				id: "/api/chat/chat",
				pattern: /^\/api\/chat\/chat\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-CMUWLr6W.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-D2bphE8u.js'))
			},
			{
				id: "/api/reports/[id]",
				pattern: /^\/api\/reports\/([^/]+?)\/?$/,
				...
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-DorXMxI_.js'))
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-G6oCrHD-.js'))
			},
			{
				...
				params: [{"name":"id","optional":false,"rest":false,"chained":false},{"name":"filePath","optional":false,"rest":true,"chained":true}],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-BRIGPISF.js'))
			},
			{
				...
				params: [{"name":"id","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-CzIQX_vc.js'))
			},
			{
				...
				params: [{"name":"id","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-BKY6_9am.js'))
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-DZcm6UXx.js'))
			},
			{
				...
				params: [{"name":"id","optional":false,"rest":false,"chained":false},{"name":"nodeKey","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-CyF-RFh3.js'))
			},
			{
				id: "/lab/icons",
				pattern: /^\/lab\/icons\/?$/,
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-B1KAiVfs.js'))
			},
			{
