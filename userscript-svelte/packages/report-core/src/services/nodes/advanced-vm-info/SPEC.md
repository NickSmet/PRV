...
Defined in `packages/report-core/src/services/nodes/advanced-vm-info/parseAdvancedVmInfo.ts` (and exported via `packages/report-core/src/services/index.ts` / `@prv/report-core`).
...
Implementation: `packages/report-ui-svelte/src/components/advanced-vm-info/advanced-vm-info-bundle-contents.svelte`
